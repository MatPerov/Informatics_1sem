...
WIDTH = 900
HEIGHT = 600
a=['green','red','white','black','blue','cyan','yellow','magenta']
...
class Ball:
    def __init__(self, *args):
        ...
        self.dx, self.dy = (20, 20) # это по сути шаг движения шаров. если увеличить -- будут двигаться быстрее
        self.ball_id = canvas.create_oval(self.x - self.R,
                                     self.y - self.R,
                                     self.x + self.R,
                                     self.y + self.R, fill=a[randint(0,7)]) # при создании шарика отрисовываем его
...
canvas.bind('<Button-3>', click_handler2)
